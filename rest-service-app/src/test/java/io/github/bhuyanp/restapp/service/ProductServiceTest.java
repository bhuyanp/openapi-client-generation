...
class ProductServiceTest {
    ...
    void getProduct_shouldReturnProduct() {
        ...
        Product product = productService.getProduct("id1");
    ...
    void getProduct_shouldThrowDownstreamExceptionWhenNoProductFound() {
        ...
        // then
        assertThatThrownBy(()->productService.getProduct("id1"))
    ...
    void updateProduct_shouldUpdateAllFields() {
        ...
        ProductEntity finalProductEntity = new ProductEntity("id1","title2",  Product.TYPE.ELECTRONICS, 22.12, createdDate, updatedDate);
        ...
        Product product = productService.updateProduct("id1",productRequest);
    ...
    void updateProduct_shouldUpdatePartially() {
        ...
        ProductEntity existingProductEntity = new ProductEntity("id1","title1",  Product.TYPE.ELECTRONICS, 12.12, createdDate, null);
        ProductEntity finalProductEntity = new ProductEntity("id1","title1",  Product.TYPE.ELECTRONICS, 22.12, createdDate, updatedDate);
