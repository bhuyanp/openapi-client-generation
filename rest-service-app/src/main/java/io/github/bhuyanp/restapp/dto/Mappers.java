...
public class Mappers {
    public static final Function<ProductRequest, ProductEntity> ADD_PRODUCT_REQ_TO_PRODUCT_ENTITY = product -> new ProductEntity(null, product.title(), product.type(), product.price(), LocalDateTime.now(), null);
    ...
    public static final BiFunction<Product, ProductRequest, ProductEntity> MERGE_PRODUCTS_TO_PRODUCT = (existingProduct, incomingProductRequest) ->
            new ProductEntity(
                    existingProduct.id(),
